...
flags.DEFINE_enum('mode', 'jax_gpu', ['jax_cpu', 'jax_gpu', 'jax_tpu'],
                  'Distributed strategy approach.')

flags.DEFINE_string('base_folder', 'data/capture1/exp', 'where to store ckpts and logs')
flags.mark_flag_as_required('base_folder')
flags.DEFINE_string('data_dir', 'data/capture1', 'input data directory.')
flags.DEFINE_multi_string('gin_bindings', None, 'Gin parameter bindings.')
flags.DEFINE_multi_string('gin_configs', 'configs/test_vrig.gin', 'Gin config files.')
FLAGS = flags.FLAGS
